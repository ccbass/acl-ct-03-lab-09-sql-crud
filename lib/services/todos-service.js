...
const { selectAllToDos, selectOneToDo, insertOneToDo, updateOneToDo, deleteOneToDo } = require('../models/todos');
...
class ToDoService {
    ...
    static async deleteToDo({ id }) {
        const toDo = await deleteOneToDo(id)

        return {details: 'deleted todo', data: toDo};
    }
}
